Hooks:PostHook(UpgradesTweakData, "init", "ThirdWeapon_UPTweakData", function(self) 
	...
	table.insert(self.level_tree[1].upgrades, "frag_tp_akm_gold") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_akmsu") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_amcar") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_arbiter") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_arblast") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_asval") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_aug") 
	...
	table.insert(self.level_tree[1].upgrades, "frag_tp_breech") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_c96") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_china") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_chinchilla") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_ching") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_coal") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_cobray") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_colt_1911") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_contraband") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_deagle") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_desertfox") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_erma") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_fal") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_famas") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_flamethrower_mk2") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_flint") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_frankish") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_g22c") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_g26") 
	...
	table.insert(self.level_tree[1].upgrades, "frag_tp_hajk") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_hk21") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_hs2000") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_hunter") 
	...
	table.insert(self.level_tree[1].upgrades, "frag_tp_mg42") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_model70") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_mosin") 
	...
	table.insert(self.level_tree[1].upgrades, "frag_tp_new_raging_bull") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_olympic") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_p226") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_p90") 
	...
	table.insert(self.level_tree[1].upgrades, "frag_tp_saiga") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_saw") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_saw_secondary") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_scar") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_schakal") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_scorpion") 
	...
	table.insert(self.level_tree[1].upgrades, "frag_tp_sterling") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_striker") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_sub2000") 
	...
	table.insert(self.level_tree[1].upgrades, "frag_tp_x_basset") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_x_chinchilla") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_x_deagle") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_x_g17") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_x_g22c") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_x_mp5") 
	table.insert(self.level_tree[1].upgrades, "frag_tp_x_packrat") 
...
Hooks:PostHook(UpgradesTweakData, "_grenades_definitions", "ThirdWeapon_grenades_definitions", function(self, ...) 
	...
	self.definitions.frag_tp_akm_gold = {category = "grenade"} 
	self.definitions.frag_tp_akmsu = {category = "grenade"} 
	self.definitions.frag_tp_amcar = {category = "grenade"} 
	self.definitions.frag_tp_arbiter = {category = "grenade"} 
	self.definitions.frag_tp_arblast = {category = "grenade"} 
	self.definitions.frag_tp_asval = {category = "grenade"} 
	self.definitions.frag_tp_aug = {category = "grenade"} 
	...
	self.definitions.frag_tp_breech = {category = "grenade"} 
	self.definitions.frag_tp_c96 = {category = "grenade"} 
	self.definitions.frag_tp_china = {category = "grenade"} 
	self.definitions.frag_tp_chinchilla = {category = "grenade"} 
	self.definitions.frag_tp_ching = {category = "grenade"} 
	self.definitions.frag_tp_coal = {category = "grenade"} 
	self.definitions.frag_tp_cobray = {category = "grenade"} 
	self.definitions.frag_tp_colt_1911 = {category = "grenade"} 
	self.definitions.frag_tp_contraband = {category = "grenade"} 
	self.definitions.frag_tp_deagle = {category = "grenade"} 
	self.definitions.frag_tp_desertfox = {category = "grenade"} 
	self.definitions.frag_tp_erma = {category = "grenade"} 
	self.definitions.frag_tp_fal = {category = "grenade"} 
	self.definitions.frag_tp_famas = {category = "grenade"} 
	self.definitions.frag_tp_flamethrower_mk2 = {category = "grenade"} 
	self.definitions.frag_tp_flint = {category = "grenade"} 
	self.definitions.frag_tp_frankish = {category = "grenade"} 
	self.definitions.frag_tp_g22c = {category = "grenade"} 
	self.definitions.frag_tp_g26 = {category = "grenade"} 
	...
	self.definitions.frag_tp_hajk = {category = "grenade"} 
	self.definitions.frag_tp_hk21 = {category = "grenade"} 
	self.definitions.frag_tp_hs2000 = {category = "grenade"} 
	self.definitions.frag_tp_hunter = {category = "grenade"} 
	...
	self.definitions.frag_tp_mg42 = {category = "grenade"} 
	self.definitions.frag_tp_model70 = {category = "grenade"} 
	self.definitions.frag_tp_mosin = {category = "grenade"} 
	...
	self.definitions.frag_tp_new_raging_bull = {category = "grenade"} 
	self.definitions.frag_tp_olympic = {category = "grenade"} 
	self.definitions.frag_tp_p226 = {category = "grenade"} 
	self.definitions.frag_tp_p90 = {category = "grenade"} 
	...
	self.definitions.frag_tp_saiga = {category = "grenade"} 
	self.definitions.frag_tp_saw = {category = "grenade"} 
	self.definitions.frag_tp_saw_secondary = {category = "grenade"} 
	self.definitions.frag_tp_scar = {category = "grenade"} 
	self.definitions.frag_tp_schakal = {category = "grenade"} 
	self.definitions.frag_tp_scorpion = {category = "grenade"} 
	...
	self.definitions.frag_tp_sterling = {category = "grenade"} 
	self.definitions.frag_tp_striker = {category = "grenade"} 
	self.definitions.frag_tp_sub2000 = {category = "grenade"} 
	...
	self.definitions.frag_tp_x_basset = {category = "grenade"} 
	self.definitions.frag_tp_x_chinchilla = {category = "grenade"} 
	self.definitions.frag_tp_x_deagle = {category = "grenade"} 
	self.definitions.frag_tp_x_g17 = {category = "grenade"} 
	self.definitions.frag_tp_x_g22c = {category = "grenade"} 
	self.definitions.frag_tp_x_mp5 = {category = "grenade"} 
	self.definitions.frag_tp_x_packrat = {category = "grenade"} 
